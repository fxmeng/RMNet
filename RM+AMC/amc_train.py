...
def parse_args():
    ...
    parser.add_argument('--model_type', default='mobilenetv2', type=str,
        choices=['mobilenetv2', 'mobilenetv1'],
    ...
    parser.add_argument('--data_root', default='/dev/shm', type=str, help='dataset path')
    # resume
...
def get_model(args):
    ...
    net = ckpt_to_model(args.ckpt_path,args.model_type,n_class)
